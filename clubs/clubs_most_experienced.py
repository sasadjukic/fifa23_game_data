...
def display_most_experienced_teams(experienced_teams: pd.Series) -> None:

    teams = experienced_teams.index.tolist()
    avg_age = experienced_teams.values.tolist()
    colors = [
              '#C21010', '#C21010', '#FFD4B2', 
              '#FFD4B2', '#FFF6BD', '#FFF6BD',
              '#86C8BC', '#86C8BC', '#86C8BC', 
              '#86C8BC'
              ]
